...
{
     private $api_key;
     private $api_endpoint = 'https://m2m-api.telefonica.com:8010/services/REST/GlobalM2M';
     const TIMEOUT = 10;
     ...
     public function __construct($api_key, $api_endpoint = null)
    {
        if (!function_exists('curl_init') || !function_exists('curl_setopt')) {
            throw new \Exception("cURL Necesita soporte");
        }
        ...
        if ($api_endpoint === null) {
            if (strpos($this->api_key, '-') === false) {
                throw new \Exception("Invalid Movistar API key `{$api_key}`.");
            }
